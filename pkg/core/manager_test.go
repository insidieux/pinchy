...
func (s *managerRunTestSuite) TestErrorDeregisterOrphan() {
	...
	registryMock.On(`Deregister`, ctx, &Service{Name: `service-2`}).Return(errors.New(`expected error`))
...
func (s *managerRunTestSuite) TestSuccess() {
	...
	registryMock := new(MockRegistry)
	registryMock.On(`Fetch`, ctx).Return(Services{{Name: `service-2`}}, nil)
	registryMock.On(`Deregister`, ctx, &Service{Name: `service-2`}).Return(nil)
...
func (_m *MockRegistry) Deregister(ctx context.Context, service *Service) error {
